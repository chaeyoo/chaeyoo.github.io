				...
				<>
					<div className="experience-item">
						...
						<div className="job-description">
							<ul>
								<li>
									웰잇고 고도화에 따른 신규 및 개선 요구사항 수렴하여 작업 진행
								</li>
							...
							<p className="highlight">
								...
								웰잇고 서비스를 운영하는 2개의 팀에 직접 어드민 사이트의 신규 및 개선 요구사항을 조사하여 고도화를 진행하였습니다.
					...
					<div className="experience-item">
						...
						<div className="job-description">
							...
							<p className="highlight">
								건강 관리 서비스 “웰잇고”는 챗봇을 적극적으로 활용한 서비스입니다.
					...
					<div className="experience-item">
						...
						<div className="job-description">
							...
							<p className="highlight">
								...
								프로젝트와 데이터 설계 부터, 프론트엔드 백엔드를 전담하여 진행하였습니다.
								빌더를 사용하여 제작한 챗봇은 "웰잇고"와 "고개들고" 등 회사의 여러 서비스에서
								사용되고 있습니다. 봇빌더 프로젝트를 성공적으로 개발하고 2차 고도화까지 진행하여
								좋은 성과로 평가받아 조기 진급을 하였습니다. 처음으로 주도적으로
								...
								이러한 방식으로 진행을 하면서 혼자 개발을 하는 환경에서 앞으로 나아가고
					...
					<div className="experience-item">
						...
						<div className="job-description">
							...
							<p className="highlight">
								"건강이로움" 백오피스 프로젝트에서 React 프론트엔드와 Java/Spring
								백엔드로 구현하였습니다.
							</p>
						</div>
					</div>
